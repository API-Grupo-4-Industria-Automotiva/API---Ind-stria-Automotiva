...
Como CADI quero analisar os principais indicadores do setor automotivo da região, para identificar oportunidades de modernização e parceria tecnológica| 1 |
Como CADI, quero entender as demandas tecnológicas das empresas automotivas, para direcionar políticas de apoio à inovação industrial|   -        | 1      |
