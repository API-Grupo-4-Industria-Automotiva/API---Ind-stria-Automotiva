...
| 1 | Alta | Como CADI, quero visualizar dados comparativos sobre competitividade e infraestrutura, para avaliar meu posicionamento frente ao mercado regional| Alta |
Como CADI quero analisar os principais indicadores do setor automotivo da região, para identificar oportunidades de modernização e parceria tecnológica| Alta | 
