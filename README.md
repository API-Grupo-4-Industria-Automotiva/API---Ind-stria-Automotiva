...
|------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|------------|--------|
| 1    | Alta       | Como aprendizes de analista, mapearemos o ecossistema industrial de serviços de São José dos Campo-SP e região, identificando os principais setores, processos produtivos e desafios tecnológicos das empresas locais                                                    |   -        | 1      |
| 2| Alta       |  Como aprendizes de analista, iniciaremos o levantamento das informações pertinentes aos processos de importação e exportação arquivo CSV do setor automotivo do vale do paraiba.                                                                   | -         | 1      |
